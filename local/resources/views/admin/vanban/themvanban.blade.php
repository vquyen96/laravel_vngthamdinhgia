...
@stop
	<h1 class="page-header">Thêm Văn Bản</h1>
	<div id="main">
		<form method="post" action="{{asset('quanlyvanban/postadd')}}" enctype="multipart/form-data">
			<div class="row">
				<div id="content-left" class="col-md-6">

					<p>Tên Văn Bản</p>
					<input type="text" name="ten_vb" required="">
